...
public class Creature extends Actor
{
    ...
    /**
     * Switches the creature to a different one
     * 
     * @param idx The index of the creature to change to.
    ...
    /**
     * Runs when the current creature is called into the battle
     * 
     * @param None There ae no parameters
     * @return Returns nothing
     */
